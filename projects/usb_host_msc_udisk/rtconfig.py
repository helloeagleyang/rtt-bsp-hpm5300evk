...
if PLATFORM == 'gcc':
    ...
    CFLAGS = ARCH_ABI  + ' -DUSE_NONVECTOR_MODE=1  -DUSB_HOST_MCU_CORE=HPM_CORE0 -DCONFIG_NOT_ENABLE_DCACHE -DRT_DFS_ELM_USE_EXFAT=1 -D__USE_EXT_DISKIO -DUSB_FATFS_ENABLE=1 -DCONFIG_USB_DCACHE_ENABLE=1 -DCONFIG_CHERRYUSB_CUSTOM_IRQ_HANDLER=1 ' + ' -mtune=andes-d25-series  -Wall -Wno-undef -Wno-unused-variable -Wno-format -Wno-ignored-attributes -fomit-frame-pointer -fno-builtin -ffunction-sections -fdata-sections  -Wno-implicit-function-declaration'
    AFLAGS = CFLAGS
